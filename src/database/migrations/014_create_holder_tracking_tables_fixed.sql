...
DROP FUNCTION IF EXISTS calculate_gini_coefficient CASCADE;
DROP FUNCTION IF EXISTS classify_holder CASCADE;
DROP FUNCTION IF EXISTS update_holder_metrics CASCADE;
